...
import cn.choleece.base.springboot.mybatis.plugin.handler.CryptUtils;
...
/**
 * @author choleece
 * @Description: MethodCryptMetadata 的建造者
 * @Date 2020-09-13 21:47
 **/
public class MethodCryptMetadataBuilder {

    static final MethodEncryptResolver EMPTY_ENCRYPT_RESOLVER = new EmptyMethodEncryptResolver();
    static final MethodDecryptResolver EMPTY_DECRYPT_RESOLVER = new EmptyMethodDecryptResolver();
    ...
    private List<MethodAnnotationEncryptParameter> getCryptParams(Method m) {
        ...
        for (int i = 0; i < parameters.length; i++) {
            ...
            if (CryptUtils.inIgnoreClass(parameters[i].getType())) {
                continue;
            }
