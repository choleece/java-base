...
import static cn.choleece.base.db.pool.hikari.metrics.prometheus.PrometheusMetricsTrackerFactory.RegistrationStatus.REGISTERED;
...
class PrometheusMetricsTracker implements IMetricsTracker
{
   ...
   private final static Map<CollectorRegistry, PrometheusMetricsTrackerFactory.RegistrationStatus> registrationStatuses = new ConcurrentHashMap<>();
