...
import cn.choleece.base.db.pool.hikari.HikariPoolMXBean;
...
import cn.choleece.base.db.pool.hikari.metrics.dropwizard.CodahaleHealthChecker;
import cn.choleece.base.db.pool.hikari.metrics.dropwizard.CodahaleMetricsTrackerFactory;
import cn.choleece.base.db.pool.hikari.metrics.micrometer.MicrometerMetricsTrackerFactory;
import cn.choleece.base.db.pool.hikari.util.ConcurrentBag;
import cn.choleece.base.db.pool.hikari.util.SuspendResumeLock;
...
import static cn.choleece.base.db.pool.hikari.util.ClockSource.*;
import static cn.choleece.base.db.pool.hikari.util.ConcurrentBag.IConcurrentBagEntry.STATE_IN_USE;
import static cn.choleece.base.db.pool.hikari.util.ConcurrentBag.IConcurrentBagEntry.STATE_NOT_IN_USE;
import static cn.choleece.base.db.pool.hikari.util.UtilityElf.*;
 ...
 *
 * 连接池主要的类，里边提供HikariCP提供的基本的连接池操作方法
 *
 * HikariPoolMXBean 提供HikariPool基本方法名，具体实现看实现类，HikariPoolMXBean接口里有中文注释分别说明每个方法都是干什么的
 */
public final class HikariPool extends PoolBase implements HikariPoolMXBean, ConcurrentBag.IBagStateListener {
    ...
    * through  then {@code owner} is {@code true}.
    *
